...
En este repositorio te dejo el código realizado en nuestra sesión en vivo en donde estuvimos aprendiendo cómo trabajar con la librería Styled components para poder llevar tus skills de CSS más allá.

El código que ves aquí es el mismo que escribo en [este video](https://youtu.be/4Cvs2quWfHQ) en YouTube. Espero le puedas sacar un buen uso.
